...
The mock API now supports real text-to-speech generation with Xiaomi MiMo `mimo-v2-tts`.
...
- This integration uses Xiaomi MiMo `mimo-v2-tts` via `https://api.xiaomimimo.com/v1/chat/completions`
